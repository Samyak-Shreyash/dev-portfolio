...
export const ACCOMPLISHMENTS = [
  ...
  },
  {
    ...
    description: "Created Wells Fargo-Cisco Bridge tool increasing the efficiency by 78%",
    icon: <Laptop className="h-6 w-6" />,
  },
  {
    date: "Dec 2015",
    title: "Intern at SafeSecurity, IIT Bombay",
    description: "Developed a Threat Life Company Management Web Application.",
    icon: <Briefcase className="h-6 w-6" />,
  },
  {
    date: "Jan 2015",
  ...
  },
  {
    ...
    description: "Started graduation studies with Computer Science Engineering",
    icon: <GraduationCap className="h-6 w-6" />,
  },
  {
    date: "Mar 2013",
    title: "Graduated from Senior Secondary School",
    description: "Concluded Secondary Education from JVM, Shyamali, Ranchi wih Science and Computer Science",
    icon: <GraduationCap className="h-6 w-6" />,
  },
  {
    date: "Mar 2011",
...
export const siteMetaData = {
  ...
  locale: "en-US",
  theme: "system",
  siteUrl: `${process.env.NEXT_PUBLIC_BASE_URL || "samyakshreyash.in"}`,
  siteLogo: `${process.env.NEXT_PUBLIC_BASE_URL || "samyakshreyash.in"}/uploads/${DEV_IMAGE}`,
  socialBanner: `${process.env.NEXT_PUBLIC_BASE_URL || "samyakshreyash.in"}/uploads/${DEV_IMAGE}`,
  email: DEV_EMAIL,
  socialLinks: {
    github: DEV_GITHUB,
